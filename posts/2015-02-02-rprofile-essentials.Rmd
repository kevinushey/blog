...
silence the noisy function with `suppressWarnings()`,
...
I've seen many a novice programmer get stumped because
the path they tried to copy from an error message
wouldn't work...
